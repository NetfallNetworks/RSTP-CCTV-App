 ...
 *
 * The rule this encodes: the Enable Server switch's own last position is the boot
 ...
 * it back after `BOOT_COMPLETED`. A device that has never had the switch touched
 ...
 * reboot -- it is a deliberate "not now", not a crash to route around.
 */
